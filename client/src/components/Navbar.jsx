    ...
    <nav className="bg-[#0c0e16]/40 backdrop-blur-xl docked full-width top-0 sticky z-50 shadow-[0_20px_40px_rgba(0,0,0,0.4)]">
      <div className="flex justify-between items-center w-full px-8 py-4 max-w-7xl mx-auto">
        ...
        <div className="hidden md:flex items-center space-x-10">
          <a className="font-['Space_Grotesk'] tracking-wide uppercase text-sm font-bold text-[#00E5FF] border-b-2 border-[#00E5FF] pb-1" href="#hero">Explore</a>
          <a className="font-['Space_Grotesk'] tracking-wide uppercase text-sm font-bold text-slate-400 hover:text-white transition-colors" href="#how-it-works">How It Works</a>
          <a className="font-['Space_Grotesk'] tracking-wide uppercase text-sm font-bold text-slate-400 hover:text-white transition-colors" href="#features">Features</a>
        </div>
